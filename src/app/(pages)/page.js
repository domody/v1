      ...
      <div className="flex h-full flex-col items-center justify-between pt-32 font-normal text-nero-800 dark:text-nero-200">
        <div className="container w-full">
          <div className="relative flex w-full items-start justify-start">
            ...
            {bgImage && (
              <Image
                className={`transfrom absolute -top-56 left-1/4 -z-10 !h-auto !max-w-[55rem] sm:left-0 md:!max-w-full lg:-top-72 ${rand == 1 || rand == 2 || rand == 4 || rand == 5 ? '-translate-x-[63%] sm:-translate-x-1/2' : '-translate-x-1/2'}`}
                src={bgImage}
                alt=""
                layout="intrinsic"
              />
